...
public class ShipBarcodeScanFragment extends Fragment {

    boolean isScannedShip = false;
    ...
    public ShipBarcodeScanFragment(ProductListInterface productListInterface) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ship_barcode_scan, container, false);
